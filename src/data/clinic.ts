...
export const treatments: Treatment[] = [
  ...
  { id: 'botox-korea', name: 'Botox Korea', blurb: 'Kurangi kerutan dinamis & garis ekspresi. Harga per unit.', category: 'Injeksi', duration: '60 min', price: 45_000, available: true, bestSeller: true },
  { id: 'botox-us', name: 'Botox US/Europe', blurb: 'Kurangi kerutan dinamis & garis ekspresi. Harga per unit.', category: 'Injeksi', duration: '60 min', price: 80_000, available: true },
